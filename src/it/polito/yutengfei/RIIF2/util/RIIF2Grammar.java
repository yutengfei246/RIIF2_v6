...
public class RIIF2Grammar {;
    ...
    public static final String TYPE_ASSOCIATIVE = "associative";
    ...
    public static final String FUNC_EXP = "function-exp";
    public static final String FUNC_LOG = "function-log";
