...
public interface RIIF2Listener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link RIIF2Parser#aisDeclarator}.
	 * @param ctx the parse tree
	 */
	void enterAisDeclarator(RIIF2Parser.AisDeclaratorContext ctx);
	/**
	 * Exit a parse tree produced by {@link RIIF2Parser#aisDeclarator}.
	 * @param ctx the parse tree
	 */
	 ...
	 * @param ctx the parse tree
	 */
	void enterPrimitiveFieldDeclaratorId1(RIIF2Parser.PrimitiveFieldDeclaratorId1Context ctx);
	/**
	 * Exit a parse tree produced by the {@code primitiveFieldDeclaratorId1}
	 * labeled alternative in {@link RIIF2Parser#primitiveFieldDeclaratorId}.
	 * @param ctx the parse tree
	 */
	void exitPrimitiveFieldDeclaratorId1(RIIF2Parser.PrimitiveFieldDeclaratorId1Context ctx);
	/**
	 * Enter a parse tree produced by the {@code primitiveFieldDeclaratorId2}
	 * labeled alternative in {@link RIIF2Parser#primitiveFieldDeclaratorId}.
	 * @param ctx the parse tree
	 */
	void enterPrimitiveFieldDeclaratorId2(RIIF2Parser.PrimitiveFieldDeclaratorId2Context ctx);
	/**
	 * Exit a parse tree produced by the {@code primitiveFieldDeclaratorId2}
	 * labeled alternative in {@link RIIF2Parser#primitiveFieldDeclaratorId}.
	 * @param ctx the parse tree
	 */
	void exitPrimitiveFieldDeclaratorId2(RIIF2Parser.PrimitiveFieldDeclaratorId2Context ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by the {@code attributePrimitiveIdIndex}
	 * labeled alternative in {@link RIIF2Parser#attributeId}.
	 * @param ctx the parse tree
	 */
	void enterAttributePrimitiveIdIndex(RIIF2Parser.AttributePrimitiveIdIndexContext ctx);
	/**
	 * Exit a parse tree produced by the {@code attributePrimitiveIdIndex}
	 * labeled alternative in {@link RIIF2Parser#attributeId}.
	 * @param ctx the parse tree
	 */
	 ...
	 * @param ctx the parse tree
	 */
	void enterHierPostfix(RIIF2Parser.HierPostfixContext ctx);
	/**
	 * Exit a parse tree produced by {@link RIIF2Parser#hierPostfix}.
	 * @param ctx the parse tree
	 */
	void exitHierPostfix(RIIF2Parser.HierPostfixContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link RIIF2Parser#aisType}.
	 * @param ctx the parse tree
	 */
	void enterAisType(RIIF2Parser.AisTypeContext ctx);
	/**
	 * Exit a parse tree produced by {@link RIIF2Parser#aisType}.
	 * @param ctx the parse tree
	 */
	void exitAisType(RIIF2Parser.AisTypeContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link RIIF2Parser#flatVector}.
	 * @param ctx the parse tree
	 */
	void enterFlatVector(RIIF2Parser.FlatVectorContext ctx);
	/**
	 * Exit a parse tree produced by {@link RIIF2Parser#flatVector}.
	 * @param ctx the parse tree
	 */
